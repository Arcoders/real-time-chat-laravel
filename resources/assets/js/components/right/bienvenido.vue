<template>
    <div id="right_app">
        ...
        <div class="chat-head">
            <md-icon class="md-size-2x margin_icon">group</md-icon>
            <div class="chat-name">
                <h1 class="font-name">Manage private groups</h1>
                <p class="font-online">With auto select and alternate headers...</p>
            </div>
        </div>
